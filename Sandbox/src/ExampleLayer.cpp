	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	m_Shader = MyHazel::Shader::Create("VertexPosColor", vertexSrc, fragmentSrc);
	...
	m_FlatColorShader = MyHazel::Shader::Create("FlatColor", flatColorShaderVertexSrc, flatColorShaderFragmentSrc);

	auto textureShader = m_ShaderLibrary.load("assets/shaders/Texture.glsl");

	m_Texture = MyHazel::Texture2D::Create("assets/textures/Checkerboard.png");
	m_ChernoLogoTexture = MyHazel::Texture2D::Create("assets/textures/ChernoLogo.png");
...
void ExampleLayer::OnUpdate(MyHazel::Timestep ts)
{
	// Update
	...
	for (int y = 0; y < 20; y++)
	{
		for (int x = 0; x < 20; x++)
		{
			...
			MyHazel::Renderer::Submit(m_FlatColorShader, m_SquareVA, transform);
		}
	}
...
void ExampleLayer::OnEvent(MyHazel::Event& e)
{
